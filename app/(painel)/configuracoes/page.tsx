      ...
      <div className="space-y-5">
        <section className="rounded-[32px] bg-gradient-to-r from-zinc-950 via-zinc-900 to-zinc-950 px-6 py-7 text-white shadow-sm">
          ...
          <p className="mt-2 max-w-2xl text-sm text-zinc-300">
            Ajuste dados do salão, agenda, horários, taxas, regras do caixa, usuários e preferências do sistema.
          </p>
        </section>
      ...
      {usuarioModalOpen ? (
        <div className="fixed inset-0 z-[90] flex items-center justify-center bg-black/55 p-4 backdrop-blur-md">
          <div className="w-full max-w-xl overflow-hidden rounded-[32px] border border-white/10 bg-white shadow-[0_30px_80px_rgba(0,0,0,0.25)]">
            <div className="bg-gradient-to-r from-zinc-950 via-zinc-900 to-zinc-800 px-6 py-5 text-white">
              <div className="flex items-start justify-between gap-4">
                <div>
                  <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/10 px-3 py-1 text-xs font-semibold uppercase tracking-[0.18em] text-zinc-200">
                    <UserCog size={14} />
                    Usuário
                  </div>
