...
export default function ComissoesPage() {
  ...
  }, [busca, dataFinal, dataInicial, idSalao, profissionalId, status, supabase]);
    ...
    <div className="bg-white">
      <div className="mx-auto max-w-[1800px] space-y-5">
        ...
        <div className="rounded-[28px] border border-zinc-200 bg-white p-5 shadow-sm">
          <div className="grid grid-cols-1 gap-4 xl:grid-cols-[1.1fr_220px_240px_180px_180px_auto]">
        ...
        <div className="rounded-[28px] border border-zinc-200 bg-white p-5 shadow-sm">
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div><div className="text-xs font-semibold uppercase tracking-[0.18em] text-zinc-500">Visao por profissional</div><div className="mt-1 text-xl font-bold text-zinc-950">Quem mais acumulou comissao</div></div>
            <div className="inline-flex items-center gap-2 rounded-2xl border border-zinc-200 bg-zinc-50 px-3 py-2 text-sm text-zinc-700"><Layers3 size={16} />{resumoProfissionais.length} profissional(is)</div>
          </div>
