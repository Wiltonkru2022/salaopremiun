      ...
      <div className="mx-auto grid min-h-[calc(100vh-4rem)] max-w-5xl overflow-hidden rounded-[32px] border border-[#d9cfc1] bg-[#fffdf9] shadow-[0_28px_90px_rgba(57,39,18,0.16)] lg:grid-cols-[1.05fr_0.95fr]">
        <section className="hidden bg-[#1f160e] p-10 text-white lg:flex lg:flex-col lg:justify-between">
          <div>
            ...
            <h1 className="mt-6 text-5xl font-black leading-[0.95] tracking-[-0.05em]">Admin Master seguro, sem depender do Supabase Auth.</h1>
            <p className="mt-5 max-w-md text-base leading-7 text-white/70">Clerk cuida da autenticação e do MFA. O banco operacional permanece no Neon.</p>
          </div>
          <div className="grid gap-3 text-sm text-white/75">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 p-4">Dados e permissões lidos do backend Neon.</div>
          </div>
        </section>
        ...
        <section className="p-6 sm:p-8 lg:p-10">
          ...
          <p className="mt-3 text-sm leading-6 text-[#6b5b45]">Use sua conta administrativa protegida pelo Clerk.</p>
