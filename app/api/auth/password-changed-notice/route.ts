      ...
      <div style="max-width:620px;margin:0 auto;background:#ffffff;border:1px solid #e2e8f0;border-radius:20px;overflow:hidden">
        <div style="padding:30px">
          ...
          <p style="margin:18px 0 0;font-size:16px;line-height:1.7;color:#475569">
            A senha do painel SalãoPremium da conta ${htmlEscape(params.email)} foi alterada em ${htmlEscape(formattedDate)}.
          </p>
          ...
          <p style="margin:18px 0 0;font-size:14px;line-height:1.7;color:#64748b">
            Se foi você, confirme abaixo. Se não foi você, solicite imediatamente uma nova recuperação de senha e fale com o suporte.
          </p>
...
export async function POST(request: Request) {
  ...
  await sendResendEmail({
    ...
    to: email,
    subject: "Sua senha foi alterada - SalãoPremium",
    ...
    text: `Sua senha do painel SalãoPremium foi alterada em ${occurredAt.toLocaleString("pt-BR")}. IP: ${ip || "não identificado"}. Navegador/dispositivo: ${userAgent || "não identificado"}. Se não foi você, solicite uma nova recuperação e fale com o suporte.`,
