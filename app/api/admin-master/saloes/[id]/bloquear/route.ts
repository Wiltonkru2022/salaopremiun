...
import {
  ...
  bloquearAdminMasterSalaoUseCase,
...
export async function POST(
  ...
  try {
    ...
    const result = await bloquearAdminMasterSalaoUseCase({
      idSalao: id,
    ...
    const message = error instanceof Error ? error.message : "Erro ao bloquear salao.";
