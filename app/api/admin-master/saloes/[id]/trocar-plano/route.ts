...
import {
  ...
  trocarPlanoAdminMasterSalaoUseCase,
...
export async function POST(
  ...
  try {
    ...
    const result = await trocarPlanoAdminMasterSalaoUseCase({
      idSalao: id,
    ...
    const message =
      error instanceof Error ? error.message : "Erro ao trocar plano do salao.";
