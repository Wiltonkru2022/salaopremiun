...
export default async function CursosPage(){
  ...
  return <main className="cursos-main"><div className="cursos-wrap">
    <section className="cursos-hero cursos-hero-home"><div className="cursos-hero-content"><span className="cursos-eyebrow"><Award size={15}/> Formação que transforma</span><h1>Aprenda na prática. Evolua com confiança.</h1><p>Cursos presenciais para profissionais da beleza que querem aperfeiçoar a técnica, encantar clientes e crescer com segurança.</p><div className="cursos-actions"><Link className="cursos-button light" href="/cursos/cadastro">Quero começar</Link><Link className="cursos-button outline" href="/cursos/login">Já sou aluna</Link></div></div></section>
