...
export const PLANOS_CATALOGO: Record<PlanoCodigo, PlanoCatalogo> = {
  teste_gratis: {
    codigo: "teste_gratis",
    nome: "Teste grátis",
    subtitulo: "15 dias com tudo liberado.",
    descricao:
      "Ideal para validar agenda, caixa, apps, estoque, comissoes e relatorios sem compromisso.",
    foco: "Experiencia completa",
    idealPara: "Quem quer testar o sistema inteiro antes de assinar.",
    valorMensal: 0,
    ordem: 0,
    recursosLiberados: [
      "Agenda",
