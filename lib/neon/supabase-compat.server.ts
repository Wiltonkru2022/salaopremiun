...
/**
 * Adaptador temporario para imports antigos com sintaxe .from()/.rpc().
 * Apesar do nome historico, nenhuma chamada de banco usa Supabase.
 * O fallback foi removido: sem Neon configurado a operacao falha fechada.
 */
