    ...
    <>
            ...
            <div className="space-y-4">
              ...
              <div className="grid gap-3 rounded-2xl border border-sky-100 bg-sky-50/60 px-4 py-3 text-sm text-slate-600 sm:grid-cols-2">
                <div className="flex items-center gap-2">
                  ...
                  <span>
                    Crédito disponivel:{" "}
                    {formatCurrency(creditoClienteDisponivel)}
                  </span>
                </div>
      ...
      {confirmarExcedenteOpen ? (
        <div className="fixed inset-0 z-[170] flex items-center justify-center bg-zinc-950/45 p-4 backdrop-blur-[2px]">
          <div className="flex max-h-[calc(100dvh-2rem)] w-full max-w-[540px] flex-col overflow-hidden rounded-lg border border-zinc-200 bg-white shadow-2xl">
            ...
            <div className="min-h-0 flex-1 overflow-y-auto px-5 py-4">
              <p className="text-sm leading-6 text-zinc-600">
                ...
                {formatCurrency(Math.max(valorBaseDigitado - faltaReceber, 0))}{" "}
                vai sair como troco ou ficar salvo como crédito para{" "}
                {clienteNome}.
              </p>
