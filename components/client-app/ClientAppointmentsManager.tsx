    ...
    <form
      ...
      onSubmit={(event) => {
        const confirmed = window.confirm(
          "Tem certeza que deseja cancelar este agendamento? O horário será liberado e essa ação pode afetar a comanda e a lista de espera."
        );
...
export default function ClientAppointmentsManager({
  ...
  const successMessage = useMemo(() => {
    ...
    if (successKey === "comprovante_enviado") {
      return "Comprovante enviado. Seu agendamento ficou na lista para conferência.";
    }
