...
function SubmitButton() { const { pending } = useFormStatus(); return <button type="submit" disabled={pending} className="h-12 w-full rounded-2xl bg-zinc-950 text-sm font-black text-white transition disabled:opacity-60">{pending ? "Criando conta..." : "Criar minha conta"}</button>; }
