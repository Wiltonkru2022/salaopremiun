  ...
  return (
    ...
    >
      ...
      <p className="mt-2 text-sm leading-6 text-zinc-500">
        Crie uma vez e use o mesmo acesso nos salões publicados no app. Se seu telefone já estiver cadastrado em algum salão, a ficha será conectada automaticamente.
      </p>

      {salaoNome ? (
        <div className="mt-4 rounded-2xl border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-900">
          Depois do cadastro, você volta para <strong>{salaoNome}</strong> e decide se quer agendar ali.
        </div>
      ) : (
        <div className="mt-4 rounded-2xl border border-zinc-200 bg-zinc-50 px-4 py-3 text-sm text-zinc-600">
          Crie a conta uma vez e use o mesmo acesso em qualquer salão publicado no app cliente.
        </div>
      )}
