...
export default function ProfissionaisBar({
  ...
  return (
    <div
      className={`overflow-hidden rounded-[20px] border border-white/75 bg-white/94 shadow-[0_12px_30px_rgba(15,23,42,0.07)] backdrop-blur ${
      ...
      <div className="flex flex-wrap items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="inline-flex h-8 w-8 items-center justify-center rounded-2xl border border-zinc-200 bg-white text-zinc-700 shadow-[0_8px_18px_rgba(15,23,42,0.05)] disabled:cursor-not-allowed disabled:opacity-45"
      ...
      >
        <div
          className={`flex min-w-max ${
            densityMode === "reception" ? "gap-1.5" : "gap-2"
          }`}
        >
          {profissionais.map((prof) => {
            ...
            return (
              <button
                ...
                className={clsx(
                  `flex items-center gap-2.5 rounded-[20px] border text-left shadow-[0_10px_26px_rgba(15,23,42,0.05)] transition ${
                    densityMode === "reception"
                      ? "min-w-[124px] px-2.5 py-1.5"
              ...
              >
                {prof.foto_url ? (
                  <img
                    ...
                    alt={prof.nome}
                    className={`${
                      densityMode === "reception" ? "h-7 w-7" : "h-7.5 w-7.5"
