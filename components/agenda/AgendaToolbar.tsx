...
export default function AgendaToolbar({
  ...
  return (
    <div className="rounded-[24px] border border-white/80 bg-white/97 px-4 py-2 shadow-[0_14px_40px_rgba(15,23,42,0.07)]">
      <div className="flex flex-col gap-1.5 lg:grid lg:grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)] lg:items-center">
        <div className="min-w-0">
          <div className="flex flex-wrap items-center gap-2">
            <h1 className="mr-2 text-[1.55rem] font-semibold tracking-[-0.07em] text-slate-900">
              Agenda
            </h1>
            ...
            <button
              type="button"
              onClick={onToday}
              className="inline-flex h-9 items-center rounded-2xl border border-zinc-200 bg-white px-3.5 text-sm font-semibold text-zinc-800 shadow-[0_8px_18px_rgba(15,23,42,0.05)] hover:bg-zinc-50"
            >
              Hoje
            </button>
            ...
            <button
              type="button"
              onClick={onPrev}
              className="inline-flex h-9 w-9 items-center justify-center rounded-2xl border border-zinc-200 bg-white text-zinc-700 shadow-[0_8px_18px_rgba(15,23,42,0.05)] hover:bg-zinc-50"
            >
              <ChevronLeft size={18} />
            </button>
            ...
            <div className="relative" ref={pickerRef}>
              <button
                ...
                className="inline-flex h-9 items-center gap-1.5 rounded-2xl border border-transparent bg-transparent px-1 text-[0.95rem] font-medium text-zinc-800"
              >
        ...
        <div className="flex items-center gap-2.5 lg:justify-end">
          <div className="rounded-[16px] border border-zinc-200 bg-white p-1 shadow-[0_8px_18px_rgba(15,23,42,0.05)]">
            <button
              type="button"
              onClick={() => onChangeView("day")}
              className={`rounded-[12px] px-4 py-1.5 text-sm font-semibold ${
                viewMode === "day"
