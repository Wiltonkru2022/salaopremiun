...
import type { ConfiguracoesSecao } from "./configuracoes-workspace-support";
import { sectionMeta, sectionHref, RATEIO_OPTIONS, TAXAS_CREDITO_KEYS, CONFIG_SELECT } from "./configuracoes-workspace-support";
