...
const exactTitles: Record<string, string> = {
  "/": "Inicio",
  "/login": "Login",
  "/cadastro-salao": "Cadastro do Salao",
  ...
  "/app-profissional/comissao": "Comissao Profissional",
...
const prefixTitles: Array<[string, string]> = [
  ...
  ["/admin-master/saloes", "Saloes Admin"],
  ...
  ["/admin-master/", "Admin Master"],
  ["/app-cliente/agendamentos/", "Avaliacao do Atendimento"],
