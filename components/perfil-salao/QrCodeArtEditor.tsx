...
const templates: TemplatePreset[] = [
  ...
  { label: "Campanha premium", kind: "top-campaign", description: "Post forte para vender serviços de beleza" },
  { label: "Promo luxo", kind: "promo-luxo", description: "Oferta com preco grande e chamada direta" },
  { label: "Agenda glam", kind: "agenda-glam", description: "Horários disponiveis com visual premium" },
  { label: "Antes e depois", kind: "before-after", description: "Dois slots para fotos de transformacao" },
  { label: "Agenda aberta", kind: "agenda", description: "Lista de horários da semana" },
  { label: "Combo de serviços", kind: "combo", description: "Serviços e precos em formato de card" },
  { label: "Depoimento", kind: "review", description: "Mensagem de cliente estilo prova social" },
  { label: "Avaliação 5 estrelas", kind: "stars-review", description: "Post para elogios e reputacao" },
  ...
  { label: "Ultimos horários", kind: "free-time", description: "Story para preencher agenda do dia" },
  { label: "Cliente do mes", kind: "client-month", description: "Post de relacionamento e carinho" },
  { label: "Menu de precos", kind: "price-menu", description: "Tabela visual para serviços principais" },
...
const startCards = [
  ...
  { label: "Agenda aberta", kind: "agenda-glam", description: "Mostre horários livres" },
  { label: "Antes e depois", kind: "before-after", description: "Mostre resultado com duas fotos" },
  { label: "Combo de serviços", kind: "combo", description: "Monte pacote e preco" },
] as const;
