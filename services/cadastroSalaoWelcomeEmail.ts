    ...
    <div style="font-family:Inter,Arial,sans-serif;background:#f8fafc;padding:32px;color:#0f172a">
      <div style="max-width:640px;margin:0 auto;background:#ffffff;border:1px solid #e2e8f0;border-radius:22px;overflow:hidden">
        <div style="background:#0f172a;padding:28px 30px;color:#ffffff">
          ...
          <h1 style="margin:0;font-size:30px;line-height:1.18">Sua conta foi criada.</h1>
          <p style="margin:14px 0 0;font-size:15px;line-height:1.7;color:#e2e8f0">
            Agora conclua a configuração inicial do salão. Seu teste grátis de 15 dias só começa depois que essa configuração for finalizada.
          </p>
        </div>

        <div style="padding:28px 30px">
          <p style="margin:0 0 18px;font-size:16px;line-height:1.7;color:#334155">
            Olá, ${responsavel}. A conta do salão <strong>${nomeSalao}</strong> foi criada com sucesso.
          </p>
          ...
          <div style="border:1px solid #e2e8f0;border-radius:18px;overflow:hidden">
            ...
            <div style="padding:16px 18px">
              ...
              <p style="margin:0;font-size:14px;line-height:1.7;color:#64748b">
                Por segurança, sua senha não é exibida nem enviada por e-mail. Se precisar, use a recuperação de acesso.
              </p>
            </div>
          </div>
          ...
          <div style="margin-top:18px;border:1px solid #fde68a;background:#fffbeb;border-radius:18px;padding:16px 18px">
            <p style="margin:0 0 8px;font-size:15px;font-weight:800;color:#92400e">Próximo passo: configurar o salão</p>
            <p style="margin:0;font-size:14px;line-height:1.7;color:#92400e">
              Configure perfil, serviços, profissionais, Produtos e Estoque se usar, Pix se desejar e seus horários. Depois da validação final, o teste grátis de 15 dias será iniciado automaticamente.
            </p>
          </div>

          <div style="margin-top:24px">
            <a href="${loginUrl}" style="display:inline-block;background:#0f172a;color:#ffffff;text-decoration:none;border-radius:999px;padding:13px 20px;font-size:14px;font-weight:800">Continuar configuração</a>
...
export async function sendCadastroSalaoWelcomeEmail(params: WelcomeEmailParams) {
  await sendBrevoEmail({
    ...
    to: params.email,
    subject: "Bem-vindo ao SalãoPremium — conclua a configuração do seu salão",
    html: buildWelcomeEmailHtml(params),
    text: [
      `Olá, ${params.responsavel}.`,
      `A conta do salão ${params.nomeSalao} foi criada com sucesso.`,
      ...
      "Conclua a configuração inicial. Seu teste grátis de 15 dias começa somente após a validação final.",
      `Continuar configuração: ${params.loginUrl}`,
