...
| `app/api/auth/password-changed-notice/route.ts` | /api/auth/password-changed-notice | sim | nao | sim | revisar |
| `app/api/auth/password-recovery/route.ts` | /api/auth/password-recovery | sim | sim | sim | revisar |
