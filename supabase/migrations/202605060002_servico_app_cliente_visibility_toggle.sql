alter table public.servicos
  alter column app_cliente_visivel set default false;
...
begin
  ...
  if p_id_servico is null then
    ...
    values (
      ...
      coalesce((p_servico->>'app_cliente_visivel')::boolean, false),
    ...
    update public.servicos
      set nome = p_servico->>'nome',
          ...
          app_cliente_visivel = coalesce((p_servico->>'app_cliente_visivel')::boolean, false),
